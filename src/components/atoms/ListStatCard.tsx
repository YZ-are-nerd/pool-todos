...
const ListStatCard: React.FC<Props> = ({list}) => {
    ...
    return (
        <div className="w-64 h-full flex flex-col shrink-0 rounded-xl p-2 gap-2 bg-neutral-700">
            <h5 className='shrink-0 line-clamp-1'>{list.title}</h5>
            <div className="w-full h-full flex items-center gap-2">
                <div className="w-full h-full flex flex-col p-2 gap-2 rounded-xl bg-neutral-900 bg-opacity-50">
            ...
            <div className="w-full h-2 mt-auto rounded-full bg-blue-600 bg-opacity-40">
